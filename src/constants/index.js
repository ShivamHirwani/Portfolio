export const myProjects = [
  {
    id: 1,
    title: "Code Buddy (AI-Powered Programmer Assistant)",
    description:
      "Code Buddy is a ai-powered programmer assistant that helps you write code faster and better.",
    subDescription: [
      "Built a scalable application with Next JS and Tailwind CSS.",
      "Implemented secure authentication and database management using google auth and convex.",
  ...
  },
  {
    ...
    description:
      "Study Buddy is an AI-powered study assistant that can generate personalized study plans and resources to help you learn faster and better.",
    subDescription: [
